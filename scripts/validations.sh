...
# Validación de Java actualizada a versión 17
if ! ls /files/OpenJDK17U-jdk_*.tar.gz 1> /dev/null 2>&1; then
    echo "Java tarball not found!"
    exit 1
fi
...
# Validaciones de Oracle DB según versión
